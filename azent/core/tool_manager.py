...
from azent.core.message import ToolMessage,ToolCallResultMessage
...
"""
    ...
    async def execute_tool(self, tool_message: ToolMessage,context:Dict[str,Any]|None=None) -> ToolCallResultMessage:
